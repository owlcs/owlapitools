...
public class ComparisonReasoner implements OWLReasoner {
	...
	public ComparisonReasoner(OWLOntology o, OWLReasonerConfiguration config,
		...
		for (int i = 0; i < delegateFactories.length; i++) {
			...
			OWLReasoner r = config == null ? delegateFactories[i].createReasoner(o)
					: delegateFactories[i].createReasoner(o, config);//, new SimpleConfiguration(new ConsoleProgressMonitor()));
	...
	public List<OWLOntologyChange> getPendingChanges() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getPendingChanges").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Set<OWLAxiom> getPendingAxiomAdditions() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getPendingAxiomAdditions").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Set<OWLAxiom> getPendingAxiomRemovals() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getPendingAxiomRemovals").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public void precomputeInferences(InferenceType... arg0) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			try {
				...
				long elapsed = bean.getCurrentThreadCpuTime() - start;
				this.timings.get(delegates.get(i)).get("precomputeInferences").values
						.add(elapsed);
			} catch (RuntimeException e) {
	...
	public Set<InferenceType> getPrecomputableInferenceTypes() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getPrecomputableInferenceTypes").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLClass> getUnsatisfiableClasses() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getUnsatisfiableClasses").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public boolean isEntailmentCheckingSupported(AxiomType<?> arg0) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("isEntailmentCheckingSupported").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLClass> getBottomClassNode() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getBottomClassNode").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLClass> getEquivalentClasses(OWLClassExpression arg0) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getEquivalentClasses").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLClass> getDisjointClasses(OWLClassExpression arg0) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getDisjointClasses").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLObjectPropertyExpression> getTopObjectPropertyNode() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getTopObjectPropertyNode").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLObjectPropertyExpression> getBottomObjectPropertyNode() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getBottomObjectPropertyNode").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLObjectPropertyExpression> getSubObjectProperties(
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getSubObjectProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLObjectPropertyExpression> getSuperObjectProperties(
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getSuperObjectProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLObjectPropertyExpression> getEquivalentObjectProperties(
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getEquivalentObjectProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLObjectPropertyExpression> getDisjointObjectProperties(
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getDisjointObjectProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLObjectPropertyExpression> getInverseObjectProperties(
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getInverseObjectProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLClass> getObjectPropertyDomains(OWLObjectPropertyExpression arg0,
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			NodeSet<OWLClass> value = delegates.get(i).getObjectPropertyDomains(arg0,
					arg1);
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getObjectPropertyDomains").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLClass> getObjectPropertyRanges(OWLObjectPropertyExpression arg0,
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getObjectPropertyRanges").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLDataProperty> getTopDataPropertyNode() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getTopDataPropertyNode").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLDataProperty> getBottomDataPropertyNode() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getBottomDataPropertyNode").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLDataProperty> getSubDataProperties(OWLDataProperty arg0,
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			NodeSet<OWLDataProperty> value = delegates.get(i).getSubDataProperties(arg0,
					arg1);
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getSubDataProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLDataProperty> getSuperDataProperties(OWLDataProperty arg0,
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			NodeSet<OWLDataProperty> value = delegates.get(i).getSuperDataProperties(
					arg0, arg1);
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getSuperDataProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLDataProperty> getEquivalentDataProperties(OWLDataProperty arg0) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			Node<OWLDataProperty> value = delegates.get(i).getEquivalentDataProperties(
					arg0);
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getEquivalentDataProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLDataProperty> getDisjointDataProperties(
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			NodeSet<OWLDataProperty> value = delegates.get(i).getDisjointDataProperties(
					arg0);
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getDisjointDataProperties").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLClass> getDataPropertyDomains(OWLDataProperty arg0, boolean arg1) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getDataPropertyDomains").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLNamedIndividual> getObjectPropertyValues(OWLNamedIndividual arg0,
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			NodeSet<OWLNamedIndividual> value = delegates.get(i).getObjectPropertyValues(
					arg0, arg1);
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getObjectPropertyValues").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Set<OWLLiteral> getDataPropertyValues(OWLNamedIndividual arg0,
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getDataPropertyValues").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public Node<OWLNamedIndividual> getSameIndividuals(OWLNamedIndividual arg0) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getSameIndividuals").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public NodeSet<OWLNamedIndividual> getDifferentIndividuals(OWLNamedIndividual arg0) {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			NodeSet<OWLNamedIndividual> value = delegates.get(i).getDifferentIndividuals(
					arg0);
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getDifferentIndividuals").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public FreshEntityPolicy getFreshEntityPolicy() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getFreshEntityPolicy").values
					.add(elapsed);
			objects.add(value);
		}
		try {
	...
	public IndividualNodeSetPolicy getIndividualNodeSetPolicy() {
		...
		for (int i = 0; i < delegates.size(); i++) {
			...
			long elapsed = bean.getCurrentThreadCpuTime() - start;
			this.timings.get(delegates.get(i)).get("getIndividualNodeSetPolicy").values
					.add(elapsed);
			objects.add(value);
		}
		try {
