...
class FillerSuggestorImpl implements FillerSuggestor {
    ...
    private abstract class AbstractOPMatcher
        ...
        @Override
        public final NodeSet<OWLClass> getLeaves(OWLClassExpression c, OWLObjectPropertyExpression p,
    ...
    private abstract class AbstractDPMatcher extends
        ...
        @Override
        public final NodeSet<OWLDatatype> getLeaves(OWLClassExpression c, OWLDataPropertyExpression p,
